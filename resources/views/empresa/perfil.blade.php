        ...
        @if ($empresa)
            ...
            <div class="min-h-screen bg-[#FDFDFB] pb-20">
                <div
                    ...
                    <h1
                        class="relative z-10 text-3xl sm:text-5xl font-black text-white uppercase tracking-tighter italic">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                        ...
                        <div class="lg:col-span-8 space-y-8">
                            <div class="bg-white rounded-[40px] p-8 sm:p-12 shadow-xl border border-gray-100/50">
                                ...
                                <div class="mb-12">
                                    <h4 class="text-[12px] font-black text-[#8B7355] uppercase tracking-[0.3em] mb-4">
                                        Radio
                                        de Operaciones</h4>
                                    <div
                        ...
                        <div class="lg:col-span-4 space-y-6">
                            <div
                                ...
                                <h4 class="text-[11px] font-black text-[#D4AF37] uppercase tracking-[0.3em]">Información
                                    de
                                    Enlace</h4>
                                    ...
                                    <div class="flex items-start gap-5">
                                        ...
                                        <div class="overflow-hidden">
                                            ...
                                            <a href="mailto:{{ $empresa->user->email }}"
                                                class="text-sm font-bold mt-1 block truncate hover:text-[#D4AF37] transition-colors">
                                                {{ $empresa->user->email }}
                                            </a>
                                        </div>
                                    </div>
