    ...
    <div class="group bg-white rounded-[35px] p-2 mb-8 border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col lg:flex-row items-stretch overflow-hidden">
        ...
        <div class="lg:w-2/4 p-8 lg:p-10 flex flex-col justify-center">
            ...
            <div class="flex flex-wrap gap-2">
                <span class="text-[9px] font-bold text-[#2D1B0F] bg-[#F5F5F0] px-4 py-1.5 rounded-lg border border-gray-100 uppercase tracking-tighter">Georreferenciación</span>
                <span class="text-[9px] font-bold text-[#2D1B0F] bg-[#F5F5F0] px-4 py-1.5 rounded-lg border border-gray-100 uppercase tracking-tighter">Levantamientos</span>
                <span class="text-[9px] font-bold text-[#2D1B0F] bg-[#F5F5F0] px-4 py-1.5 rounded-lg border border-gray-100 uppercase tracking-tighter">Drones</span>
            </div>
        </div>

        <div class="lg:w-1/4 p-8 bg-[#FDFDFB] border-l border-gray-50 flex flex-col justify-center gap-4">
            <button wire:click="" class="w-full bg-[#2D1B0F] text-[#D4AF37] py-5 rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] hover:bg-[#1A0F08] transition-all shadow-xl shadow-[#2D1B0F]/10 transform active:scale-95">
                Solicitar Servicio
            </button>
            
            <button wire:click="" class="w-full bg-white text-[#2D1B0F] border-2 border-[#F5F5F0] py-5 rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] hover:border-[#D4AF37]/30 transition-all transform active:scale-95">
                Más Información
            </button>
