            ...
            <tr class="group hover:bg-[#F5F5F0]/50 transition-all duration-200">
                ...
                <td class="px-8 py-6 text-right">
                    <div class="flex justify-end items-center gap-2">
                        <button class="p-2.5 bg-gray-50 text-[#8B7355] hover:bg-[#D4AF37]/10 hover:text-[#D4AF37] rounded-lg transition-colors group/edit">
                        ...
                        <button class="p-2.5 bg-gray-50 text-[#8B7355] hover:bg-red-50 hover:text-red-500 rounded-lg transition-colors">
